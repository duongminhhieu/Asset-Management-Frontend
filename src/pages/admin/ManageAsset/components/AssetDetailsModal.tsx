...
function AssetDetailsModal({assetData, show, handleClose}:Props) {
  ...
  >
      <Form layout="horizontal" >
        <Form.Item  label="Asset Code"  labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <div>{assetData.assetCode}</div>
        </Form.Item>
        <Form.Item label="Asset name" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <div>{assetData.name}</div>
        </Form.Item>
        <Form.Item label="Category" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <p>{assetData.category}</p>
        </Form.Item>
        <Form.Item label="Installed date" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <p>{formatDate(assetData.installDate)}</p>
        </Form.Item>
        <Form.Item label="State" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <p>{assetData.state}</p>
        </Form.Item>
        <Form.Item label="Location" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <p>{assetData.location.name}</p>
        </Form.Item>
        <Form.Item label="Specification" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
          <p>{assetData.specification}</p>
        </Form.Item>
        <Form.Item label="History" labelCol={{offset:2, span: 6 }} labelAlign="left" className="my-2">
